...
| 28 | **LOW** | 🔒 Sécurité | Utiliser `serverTimestamp()` pour streak dates | `streak_service.dart` | 1h | ❌ |
...
**Résumé** : 1 P0 · 0 P1 · 6 P2 · 1 LOW · 25 DONE | Supprimés : #7 (streak play), #22 (sons combo escaladants), #24 (joker gratuit/partie), #25 (courbe XP) | Déplacé : #15 → todo
