...
class _StreakPopupState extends ConsumerState<StreakPopup>
            ...
            child: Column(
              ...
              children: [
                ...
                if (!result.streakReset) ...[
                  ...
                  _buildButton(l10n, result.reward),
                ],
              ],
            ),
          ).animate().scale(
  ...
  Widget _buildHeader(PlayerStreak streak, AppLocalizations l10n) {
    return Column(
      children: [
        ...
        Text(
          widget.result.streakReset ? l10n.streakBrokenDesc : l10n.streakConnectedToday,
  ...
  // ── Single button: Collect or Already Collected ───────────────────────────

  Widget _buildButton(AppLocalizations l10n, (JokerType, int)? reward) {
    if (reward == null || _collected) {
    ...
    if (_showCollectAnim) {
      return _buildCollectAnimation(reward);
    }
          ...
          return Stack(
            ...
            children: [
              if (_sparkleCtrl.isAnimating)
                for (var i = 0; i < 8; i++)
                  Positioned(
                    top: 28 + math.sin((i / 8) * 2 * math.pi) * 30 * _sparkleCtrl.value,
